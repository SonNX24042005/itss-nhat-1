...
// ── Nav links config ─────────────────────────────────────────────────────────
const navLinks = [
  { label: "Trang chủ", path: "/trang-chu", icon: HomeIcon },
  { label: "Bạn bè", path: "/", icon: FriendsIcon },
  { label: "Trò chuyện", path: "/tro-chuyen", icon: ChatIcon },
  { label: "Sự kiện", path: "/su-kien", icon: EventIcon },
  { label: "Trò chơi", path: "/tro-choi", icon: GameIcon },
];
