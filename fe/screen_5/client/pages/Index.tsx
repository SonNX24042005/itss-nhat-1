    ...
    <div className="flex h-40 items-stretch rounded-2xl border border-[#E2E8E2] bg-white overflow-hidden">
      <div className="relative w-[130px] shrink-0 overflow-hidden">
        ...
        <div className="absolute top-2 left-2 flex items-center px-2 py-0.5 rounded backdrop-blur-sm border border-white/10 bg-[rgba(45,58,58,0.6)]">
          <span className="text-white text-[8px] font-bold uppercase tracking-[0.4px]">{badge}</span>
        </div>
      </div>
...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAF9] font-inter">
      {/* Header */}
      <header className="sticky top-0 z-50 bg-white border-b border-[#E2E8E2] shadow-[0_1px_2px_0_rgba(0,0,0,0.05)]">
            ...
            <nav className="hidden md:flex items-stretch h-16">
              {NAV_LINKS.map((link) => (
                <Link
                  key={link.href}
                  to={link.href}
                  className={`flex items-center gap-2 px-4 text-[14px] font-semibold leading-5 transition-colors ${
                    link.active
                      ? "text-[#4A6741] border-b-2 border-[#4A6741]"
                      : "text-[#6B7280] hover:text-[#4A6741] border-b-2 border-transparent"
                  }`}
                >
                  {link.icon}
                  <span className={link.active ? "text-[#4A6741]" : "text-[#6B7280]"}>{link.label}</span>
                </Link>
              ))}
            </nav>
          </div>
          ...
          <div className="flex items-center gap-3">
            <div className="relative hidden sm:block">
              <input
                ...
                className="w-64 lg:w-80 pl-9 pr-4 py-1.5 rounded-lg border border-[#E2E8E2] bg-[#F8FAFC] text-[12px] text-[#6B7280] outline-none focus:border-[#4A6741] focus:ring-1 focus:ring-[#4A6741] transition-colors"
              />
              <svg
            ...
            <div className="pl-4 border-l border-[#E2E8E2]">
              <div className="w-9 h-9 rounded-full bg-[#E2E8F0] shadow-[0_0_0_2px_rgba(74,103,65,0.1)] overflow-hidden">
                <img
            ...
            <div className="relative rounded-2xl bg-[#2D3A3A] overflow-hidden min-h-[200px] flex flex-col justify-end p-10">
              ...
              <div className="relative z-10 flex flex-col gap-2">
                <div className="inline-flex self-start items-center px-2.5 py-1 rounded bg-[rgba(74,103,65,0.3)] backdrop-blur-md">
                  <span className="text-white text-[10px] font-bold uppercase tracking-[1px]">WELCOME BACK</span>
                </div>
