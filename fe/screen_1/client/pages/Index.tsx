          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <button type="button" className="text-[#10B981] text-xs font-bold hover:text-[#059669] transition-colors">
                  Gửi lại mã
                </button>
              </div>
            ...
            <button
              type="submit"
              className="w-full h-[52px] bg-[#0F172A] hover:bg-[#1E293B] text-white font-bold text-[15px] rounded-lg transition-colors mt-2"
            >
              Đăng ký →
            </button>
          </form>
