...
const PEOPLE: Person[] = [
  {
    ...
    badge: "N2",
    badgeKey: "N2",
    info: "Bạn bè • 22 tuổi • Hướng ngoại",
    avatarUrl:
  ...
  },
  {
    ...
    badge: "N1",
    badgeKey: "N1",
    info: "Đồng nghiệp • 28 tuổi • Điềm đạm",
    age: 28,
    gender: "Nam",
    hobby: "Đọc sách",
    level: "N1",
  ...
  },
  {
    ...
    badge: "Bản ngữ",
    badgeKey: "母国語",
    info: "Khách hàng • 32 tuổi • Chuyên gia",
    avatarUrl:
  ...
  },
  {
    ...
    badge: "N4",
    badgeKey: "N4",
    info: "Người mới • 19 tuổi • Nhiệt tình",
    age: 19,
    gender: "Nam",
    hobby: "Chơi game",
    level: "N4",
  ...
  },
  {
    ...
    badge: "N3",
    badgeKey: "N3",
    info: "Người quen • 24 tuổi • Thân thiện",
    age: 24,
    gender: "Nam",
    hobby: "Thể thao",
    level: "N3",
  },
  {
    ...
    badge: "N1",
    badgeKey: "N1",
    info: "Đồng nghiệp • 30 tuổi • Nghiêm túc",
    age: 30,
    gender: "Nữ",
    hobby: "Đọc sách",
    level: "N1",
...
export default function Index() {
  ...
  const filtered = PEOPLE.filter((p) => {
    if (ageFilter !== "Tất cả") {
      ...
      const label = decade >= 40 ? "40 tuổi trở lên" : `Thế hệ ${decade}x`;
      if (label !== ageFilter) return false;
    }
    if (genderFilter !== "Tất cả" && p.gender !== genderFilter) return false;
    if (hobbyFilter !== "Tất cả" && p.hobby !== hobbyFilter) return false;
    if (levelFilter !== "Tất cả" && p.level !== levelFilter) return false;
    return true;
  });
          ...
          <div className="max-h-[400px] overflow-y-auto">
            {filtered.length === 0 ? (
              <div className="px-4 py-8 text-center text-[#6B7280] text-[11px]">
                Không tìm thấy người dùng phù hợp với điều kiện.
              </div>
            ) : (
